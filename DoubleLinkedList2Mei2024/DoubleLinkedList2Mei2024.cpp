...
void addNode() {
    ...
    else
    {
        ...
        if (previous != NULL)
        {
            previous->next = newNode; // step 7: Mak the next field of the previous node point to the new node
        }
        else {
...
int main()
{
    while (true)
    {
        try
        {
            ...
            cout << "4. View all records in the descending order of roll numners" << endl;
